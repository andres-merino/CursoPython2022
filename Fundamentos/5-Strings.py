...
# Concatenación de strings: es unir dos variables de tipo string en una
# sola impresión
...
print(
    f'1: Hola mi nombre es {nombre} y me edad es {edad} y tengo un ira de {ira}')
# 2. Llama al método de la clase string
print('2: Hola mi nombre es {} y mi edad es {} y tengo un ira de {}'.format(
    nombre, edad, ira))
# 3. Llama al método formar pero indicando la posición
print('3: Hola mi nombre es {0} y mi edad es {1} y tengo un ira de {2}'.format(
    nombre, edad, ira))
# Con repetición
print('Mi nombre es {0} estudio en la {1} y además trabajo en {1}'.format(
    nombre, universidad))
# 4. Formated string con reasignación de variables
print('4: Hola mi nombre es {variableNombre} y mi edad es {variableEdad} y tengo un ira de {variableIRA}'.format(
    variableNombre='Fernando', variableEdad=edad, variableIRA=ira))
# Objeto -> str
# atributos -> privados
# metodo -> format
...
# Cuando yo utilizo los número negativos, empeizo a contar de atras hacia
# adelante
